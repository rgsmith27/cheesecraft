...
public class ModItems {
    ...
    //all items
    private static final Item AGED_CHEESE_WEDGE = new Item(ModItemSettings.AGED_CHEESE_WEDGE);
    private static final Item CHEESE_CURDS = new Item(ModItemSettings.CHEESE_CURDS);
    private static final Item CHEESE_WEDGE = new Item(ModItemSettings.CHEESE_WEDGE);
    private static final Item CALF_STOMACH = new Item(ModItemSettings.CALF_STOMACH);
    private static final Item RENNET = new Item(ModItemSettings.RENNET);
    private static final Item SALT = new Item(ModItemSettings.SALT);

    //all block items
    private static final BlockItem AGED_CHEESE_WHEEL = new BlockItem(ModBlocks.AGED_CHEESE_WHEEL, (ModItemSettings.AGED_CHEESE_WHEEL));
    private static final BlockItem CHEESE_WHEEL = new BlockItem(ModBlocks.CHEESE_WHEEL, (ModItemSettings.CHEESE_WHEEL));
    private static final BlockItem FRESH_CHEESE_WHEEL = new BlockItem(ModBlocks.FRESH_CHEESE_WHEEL, (ModItemSettings.FRESH_CHEESE_WHEEL));
    private static final BlockItem SALT_BLOCK = new BlockItem(ModBlocks.SALT_BLOCK, (ModItemSettings.SALT_BLOCK));
